...
export const itemStyles = tv({
  ...
  variants: {
    isSelected: {
      ...
      true: 'bg-primary text-primary-foreground! forced-colors:bg-[Highlight] forced-colors:text-[HighlightText] [&:has(+[data-selected])]:rounded-b-none [&+[data-selected]]:rounded-t-none -outline-offset-4 outline-primary-foreground dark:outline-primary-foreground forced-colors:outline-[HighlightText]'
    },
    isDisabled: {
...
export const dropdownItemStyles = tv({
  ...
  variants: {
    ...
    isFocused: {
      // text-...! обязателен: база пункта задаёт dark:text-neutral-100, а у неё
      // специфичность (0,2,0) против (0,1,0) у обычного text-. Без important в
      // тёмной теме на лаймовой заливке остаётся светлый текст (и галка).
