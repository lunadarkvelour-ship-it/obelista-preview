/** coss ui Textarea — копия из реестра coss. API: <Textarea className size? ...rest>.
 *
 *  ОТЛИЧИЕ ОТ СТАРОГО ШИМА: coss-textarea обёрнут в <span data-slot="textarea-control">,
 *  и ref пробрасывается на <textarea> через FieldPrimitive.Control.
 */
"use client";
