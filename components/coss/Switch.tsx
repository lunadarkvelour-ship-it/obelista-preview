/** coss ui Switch — копия из реестра coss. API: SwitchPrimitive.Root.Props.
 *  Заменяет старый шим: <Switch checked onCheckedChange disabled ...rest />.
 *  Визуал coss-варианта отличается (background-color, thumb via --thumb-size).
 */
"use client";
