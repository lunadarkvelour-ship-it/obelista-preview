...
const dropZone = tv({
  ...
  variants: {
    isFocusVisible: {
      true: 'outline outline-2 -outline-offset-1 outline-focus forced-colors:outline-[Highlight]'
    },
    isDropTarget: {
      true: 'bg-blue-200 dark:bg-blue-800 outline outline-2 -outline-offset-1 outline-focus forced-colors:outline-[Highlight]'
    }
  }
});
