...
export function TailGroups() {
  ...
  return (
    <SectionCard index="08b" id="groups" title="URL param groups" note="ad accounts + pixel + URL params = a separate bundle">
      ...
      {/* LayoutGroup объединяет соседние motion.div с `layout` в один общий
          layout-граф: при добавлении/удалении группы остальные плавно
          перетекают на новое место, не дёргая границы. AnimatePresence вокруг
          уже стоял — отвечает за вход/выход item-а. */}
